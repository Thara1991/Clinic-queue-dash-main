    ...
    extend: {
      colors: {
        ...
        medical: {
          ...
          "surface-variant": "hsl(var(--medical-surface-variant))",
          "on-surface": "hsl(var(--medical-on-surface))",
          "on-surface-variant": "hsl(var(--medical-on-surface-variant))",
        },
        queue: {
          active: "hsl(var(--queue-active))",
          waiting: "hsl(var(--queue-waiting))",
          calling: "hsl(var(--queue-calling))",
